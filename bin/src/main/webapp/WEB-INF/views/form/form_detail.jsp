							...
							<div class="view_inner">
								<div class="view-info">
									<strong class="view-tit">
										<em>000001.</em>
										<em>kakao 사업 협약서 양식</em></strong>
									<ul class="ul clearfix">

										<li><span class="list-tit">작성자</span>
											<span>유길상(디자인1팀, 사원)</span>
...
<!-- 										</li> -->
										...
										<li><span class="list-tit">작성일자</span><span>2024.04.04</span></li>
										<!-- 프로젝트 상태값:
...
<!-- 첨부파일 -->
 ...
 <script>
	function moveList() {
		location.href = "${pageContext.request.contextPath }/board/formList"
	}
	function moveMod() {
		location.href = "${pageContext.request.contextPath }/board/form/modify"
	}
</script>