...
<div class="row row-cols-1 row-cols-md-4 g-4 photo_list">
	...
	<!-- col -->
	<div class="col">
		<a href="${pageContext.request.contextPath }/board/photo/detail">
			<div class="card">
				<div class="photo_img">
				...
				<div class="card-body">
					<strong class="card-title"> <em class="text-elipsis">영화보러간날
							영화보러 간 날 영화보러간날 영화보러 간 날영화보러간날 영화보러 간 날영화보러간날 영화보러 간 날영화보러간날 영화보러
							간 날영화보러간날 영화보러 간 날영화보러간날 영화보러 간 날영화보러간날 영화보러 간 날영화보러간날 영화보러 간
							날영화보러간날 영화보러 간 날영화보러간날 영화보러 간 날영화보러간날 영화보러 간 날</em>
					</strong>
				...
				<ul class="card-footer d-flex justify-content-between border-0 py-0">
					...
					<li><span><i class="icon writer"><em
								class="sr-only">작성자</em></i> 정민지 </span></li>
					<li><span><i class="icon date"><em class="sr-only">날짜</em></i>24.05.04
					</span></li>
				</ul>
			</div>
		</a>
