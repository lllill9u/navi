	...
	<div class="view_inner">
		<div class="view-info">
			<strong class="view-tit icon-tit"> <span class="icon photo"></span>
				<em>2024대덕인재개발원 리뉴얼 2024대덕인재개발원 리뉴얼 2024대덕인재개발원 리뉴얼 2024대덕인재개발원
					리뉴얼 2024대덕인재개발원 리뉴얼 2024대덕인재개발원 리뉴얼 2024대덕인재개발원 리뉴얼</em></strong>
		...
		<div class="view_content">
			...
			영화보러간 날 집에 가고 싶다. 잠이나 자고 싶다,영화가 넘 재미가 없다. 영화보러간 날 집에 가고 싶다. 잠이나 자고
...
<script>
	...
	function moveMod() {
		location.href = "${pageContext.request.contextPath }/board/photo/modify"
	}
</script>
